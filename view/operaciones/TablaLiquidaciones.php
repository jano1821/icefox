<?php
class TablaLiquidaciones {

    public function mostrarTablaLiquidaciones($htmlTabla,
                            $arrayEmpleados,
                            $arrayPuntoVenta,
                            $serie,
                            $numero,
        ...
        <html >
            ...
            <body>
                <div id ="block"></div>
                <div class="container">
                    <h1 class="titulo" align="center">Lista de Hojas de Liquidacion</h1>
                    <form action="../../view/operaciones/GetLiquidaciones.php" method="POST" name="formEnvio" id="formEnvio">
                        ...
                        <div class="buttonwrapper">
                            ...
                            <a class="ovalbutton" href="javascript:envioFormulario('');"><span>Nueva Liquidacion</span></a>
                        </div>
                        <br>
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <th>
                                        <label>Numero de Hoja de Liquidación</label>
                                        <div >
