<?php
class TablaMantenimientoDirecciones {

    public function mostrarTablaMantenimientoDirecciones($htmlTabla,
                            $codigoPersona) {
        ?>
        <!DOCTYPE html>
        <html >
            ...
            <body>
                ...
                <div id ="block"></div>
                <div class="container">
                    <h1 class="titulo" align="center">Lista de Direcciones</h1>
                    <form action="../../view/mantenimientos/GetEnvioMantenimientoDirecciones.php" method="POST" name="formEnvio" id="formEnvio">
                        ...
                        <div class="buttonwrapper">
                            ...
                            <a class="ovalbutton" href="javascript:envioFormulario('');"><span>Nueva Direccion</span></a>
                        </div>
