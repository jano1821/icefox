<?php
class TablaMantenimientoOpcionesPorPerfil{
	public function mostrarTablaMantenimientoOpcionesPorPerfil($htmlTabla){
?>
<!DOCTYPE html>
<html >
...
<body>
  ...
  <div class="container">
    ...
    <form action="../../view/mantenimientos/GetEnvioMantenimientoOpcionesPorPerfil.php" method="POST" name="formEnvio" id="formEnvio">
